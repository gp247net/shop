...
// endpoints (post_create, product_search, user_info) and the invoice/delete
// utilities stay. The product_info endpoint (getInfoProduct) was removed with the
...
// (US-SADM-order-item-attribute-select, D5). RBAC slug unchanged.
