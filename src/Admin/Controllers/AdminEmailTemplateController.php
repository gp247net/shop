...
use GP247\Shop\Admin\Models\AdminEmailTemplate;
use Validator;
...
class AdminEmailTemplateController extends RootAdminController
{
    ...
    {
        $data = [
            'title'         => gp247_language_render('admin.email_template.list'),
            'subTitle'      => '',
            'icon'          => 'fa fa-indent',
            'urlDeleteItem' => gp247_route_admin('admin_email_template.delete'),
        ...
        $listTh = [
            'name' => gp247_language_render('admin.email_template.name'),
            'group' => gp247_language_render('admin.email_template.group'),
            'status' => gp247_language_render('admin.email_template.status'),
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[$row['id']] = [
                ...
                'action' => '
                    <a href="' . gp247_route_admin('admin_email_template.edit', ['id' => $row['id'] ? $row['id'] : 'not-found-id']) . '"><span title="' . gp247_language_render('action.admin.edit') . '" type="button" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
        ...
        //menuRight
        $data['menuRight'][] = '<a href="' . gp247_route_admin('admin_email_template.create') . '" class="btn  btn-success  btn-flat" title="New" id="button_create_new">
    ...
    {
        $data = [
            'title' => gp247_language_render('admin.email_template.add_new_title'),
            'subTitle' => '',
            'title_description' => gp247_language_render('admin.email_template.add_new_des'),
            'icon' => 'fa fa-plus',
            'arrayGroup' => $this->arrayGroup(),
            'obj' => [],
            'url_action' => gp247_route_admin('admin_email_template.create'),
        ];
        return view('gp247-shop-admin::screen.email_template')
            ->with($data);
    }
    ...
    public function postCreate()
    {
        ...
        return redirect()->route('admin_email_template.index')->with('success', gp247_language_render('action.create_success'));
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            ...
            'obj' => $emailTemplate,
            'arrayGroup' => $this->arrayGroup(),
            'url_action' => gp247_route_admin('admin_email_template.edit', ['id' => $emailTemplate['id']]),
        ];
        return view('gp247-shop-admin::screen.email_template')
            ->with($data);
    }
    ...
    public function postEdit($id)
    {
        ...
        return redirect()->route('admin_email_template.index')->with('success', gp247_language_render('action.edit_success'));
    }
    ...
    */
    ...
    {
        return  [
            'order_success_to_admin' => gp247_language_render('admin.email.order_success_to_admin'),
            'order_success_to_customer' => gp247_language_render('admin.email.order_success_to_cutomer'),
            'forgot_password' => gp247_language_render('admin.email.forgot_password'),
            'customer_verify' => gp247_language_render('admin.email.customer_verify'),
            'welcome_customer' => gp247_language_render('admin.email.welcome_customer'),
            'contact_to_admin' => gp247_language_render('admin.email.contact_to_admin'),
            'other' => gp247_language_render('admin.email.other'),
        ];
    }
