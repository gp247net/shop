...
class DataShopInitializeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        AdminMenu::insertOrIgnore(
            [
                ...
                ['parent_id' => $idBlockCatalog,'sort' => 15,'title' => 'admin.menu_titles.product_tag','icon' => 'fas fa-tags','uri' => 'admin::product_tag','key' => null,'type' => 0],
    ...
    public function dataConfigShop() {
        $dataConfig = [
            ...
            ['group' => 'gp247_cart','code' => 'product_config_attribute','key' => 'product_type','value' => '1','sort' => '0','detail' => 'admin.product.config_manager.tag','store_id' => GP247_STORE_ID_GLOBAL],
            ['group' => 'gp247_cart','code' => 'product_config_attribute_required','key' => 'product_type_required','value' => '0','sort' => '0','detail' => '','store_id' => GP247_STORE_ID_GLOBAL],
            ['group' => 'gp247_cart','code' => 'product_config_attribute','key' => 'product_tags','value' => '1','sort' => '0','detail' => 'admin.product.config_manager.tags','store_id' => GP247_STORE_ID_GLOBAL],
            ['group' => 'gp247_cart','code' => 'product_config_attribute_required','key' => 'product_tags_required','value' => '0','sort' => '0','detail' => '','store_id' => GP247_STORE_ID_GLOBAL],
